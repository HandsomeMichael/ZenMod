...
namespace ZenMod.Helper
{
	...
	*/
	...
	/// you can found most recent helper in https://github.com/HandsomeMichael/Deltarune/blob/main/Helper/Helplul.cs
	/// </summary>
    public static class Helpme
    {
		...
		public static void SpawnGores(this Entity entity,params string[] textures) {
			foreach (string item in textures){
				Gore.NewGore(entity.position, entity.velocity, ZenMod.get.GetGoreSlot("Gores/"+item), 1f);
			}
		}
